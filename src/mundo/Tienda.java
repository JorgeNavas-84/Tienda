...
public class Tienda {
    ...
    public double darPromedioVentas() {
        ...
        double totalUnidadadesVendidas = producto1.darCantidadUnidadesVendidas() + producto2.darCantidadUnidadesVendidas() + producto3.darCantidadUnidadesVendidas() + producto4.darCantidadUnidadesVendidas();
        if (totalUnidadadesVendidas > 0){
            respuesta =dineroEnCaja / totalUnidadadesVendidas;
        }
        return respuesta;
    }
    ...
    public Producto darProductoMasVendido() {
        ...
        int ventas4 = producto4.darCantidadUnidadesVendidas();
        int mayorcantidad = 0;
        if (ventas1 > mayorcantidad){
            masVendido = producto1;
            mayorcantidad = ventas1;
        }
        if (ventas2 > mayorcantidad){
            masVendido = producto2;
            mayorcantidad = ventas2;
        }
        if (ventas3 > mayorcantidad){
            masVendido = producto3;
            mayorcantidad = ventas3;
        }
        if (ventas4 > mayorcantidad){
    ...
    public Producto darProductoMenosVendido() {
        ...
        if (ventas1 > 0 || ventas2 >0 || ventas3 > 0 || ventas4 > 0){
            if(ventas1 <= ventas2 && ventas1 <= ventas3 && ventas1 <= ventas4){
                menosVendido = producto1;
            } else if (ventas2 <= ventas1 && ventas2 <= ventas3 && ventas2 <= ventas4) {
                menosVendido = producto2;
            } else if (ventas3 <= ventas1 && ventas3 <= ventas2 && ventas3 <= ventas4) {
    ...
    public int metodo1() {
        int cont = 0;
        double promedio = (producto1.darValorUnitario()+producto2.darValorUnitario()+producto3.darValorUnitario()+producto4.darValorUnitario())/4;
    ...
    public String metodo2() {
        if(producto1.darValorUnitario() < producto2.darValorUnitario() &&
           producto1.darValorUnitario() < producto3.darValorUnitario() &&
           producto1.darValorUnitario() < producto4.darValorUnitario()){
            return producto1.darNombre();
        } else if (producto2.darValorUnitario() < producto1.darValorUnitario() &&
                   producto2.darValorUnitario() < producto3.darValorUnitario() &&
                   producto2.darValorUnitario() < producto4.darValorUnitario()) {
            return producto2.darNombre();
        } else if (producto3.darValorUnitario() < producto1.darValorUnitario() &&
                   producto3.darValorUnitario() < producto2.darValorUnitario() &&
                   producto3.darValorUnitario() < producto4.darValorUnitario()) {
            return producto3.darNombre();
        } else if (producto2.darValorUnitario() < producto1.darValorUnitario() &&
                   producto2.darValorUnitario() < producto3.darValorUnitario() &&
                   producto2.darValorUnitario() < producto4.darValorUnitario()) {
                   return producto2.darNombre();
        } else {
                   return producto4.darNombre();
        }
    }
}